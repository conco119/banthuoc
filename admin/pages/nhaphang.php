...
<head>
    ...
    <?php
     ...
     ?>
    <link rel="stylesheet" href="../dist/css/nhaphang.css">
            ...
            <div class="row header">
              <div class="form-horizontal">
                <div class="form-group">
                  <label class="control-label col-sm-2" for="email"><i class="fa fa-user" aria-hidden="true"></i> Tên nhân viên:</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="pwd"><i class="fa fa-truck" aria-hidden="true"></i> Nhà cung cấp:</label>
                  <div class="col-sm-10">
                    <select class="form-control" name="nhacungcap">
                      <?php
                        foreach ($nhacungcap as $key => $value) :
                       ?>
                       <option value="<?php echo $value['id'] ?>"><?php echo $value['ten_ncc'] ?></option>
                     <?php endforeach ?>
                    </select>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="email"><i class="fa fa-calendar" aria-hidden="true"></i>   Ngày nhập:</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="pwd">  </i>Tổng tiền hàng:</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" name='submit' class="btn btn-default">Hoàn thành</button>
                  </div>
                </div>
              </div> <!-- form -->
          ...
          // thêm mặt hàng vào hóa đơn
            ...
            $('tbody').delegate('.select','click',function() {
              ...
              <tr id=${id} class="odd gradeX" align="center">
                ...
                <td>
                  <input data-id=${id} class='tinhtien ${id}' type="number" name="${id}[]" value="0">
                </td>
                <td>
                  <input data-id=${id} class='tinhtien ${id}' type="number" name="${id}[]" value="${gia_von}">
                </td>
                <td>
